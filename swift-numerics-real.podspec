Pod::Spec.new do |s|
  s.name             = "swift-numerics-real"
  s.module_name     = "RealModule"
  s.version          = '1.0.2'
  s.summary          = "Real module"
  s.description      = <<-DESC
                       Things related to real numbers.
                       DESC
  ...
  s.ios.dependency 'swift-numerics-shims'
  s.source_files = 'Sources/RealModule/**/*.{h,m,swift}'
end
